 ...
 * (MUL-6243).
 *
 * List sections are categories, so two issues sitting in the same "评审中"
 * section can be on different statuses — "代码评审" and "QA" — with nothing
 ...
 * section header says "评审中" and a chip repeating it is pure noise. So a
